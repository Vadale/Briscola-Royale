...
const BALANCE = {
  ...
  cardChips: { 1: 11, 3: 10, re: 10, cavallo: 9, fante: 8, 7: 0, 6: 0, 5: 0, 4: 0, 2: 0 },
...
const JOKERS = [
  // -------- COMMON (10) --------
  {
    ...
    descriptionEn: "+30 chips on every hand played.",
  ...
  },
  {
    id: 'caffe_forte',
    name: "'O Caffè Forte",
    nameEn: "Strong Coffee",
    emoji: '☕',
    rarity: 'common',
    cost: 4,
    description: 'La prima mano del round dà chips ×3.',
    descriptionEn: "First hand of the round gives chips ×3.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+50 chips if the hand contains a King.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+20 chips for each Jack played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    id: 'pizzaiolo',
    name: "'O Pizzaiolo",
    nameEn: "The Pizzaiolo",
    emoji: '🍕',
    rarity: 'common',
    cost: 4,
    description: '+15 chips per ogni carta di Coppe giocata.',
    descriptionEn: "+15 chips for each Cups card played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+1 mult on every hand played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+25 chips if you played exactly 2 cards.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Toscano Cigar",
    emoji: '🚬',
    rarity: 'common',
    cost: 4,
    description: '+10 chips per ogni carta di Bastoni giocata.',
    descriptionEn: "+10 chips for each Clubs card played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+12 chips for each Horse played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Auntie's Amulet",
    emoji: '🧿',
    rarity: 'common',
    cost: 4,
    description: '+1 mult se nella mano c\'è un Asso.',
    descriptionEn: "+1 mult if the hand contains an Ace.",
    trigger: 'on_hand_played',
  ...
  // -------- UNCOMMON (8) --------
  {
    ...
    descriptionEn: "Coins cards give chips ×2.",
  ...
  },
  {
    ...
    descriptionEn: "Cards 5, 6, 7 give +20 chips each.",
    trigger: 'on_card_scored',
  ...
  },
  {
    ...
    descriptionEn: "+5 mult for each card discarded this round.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Good Munaciello",
    emoji: '👻',
    rarity: 'uncommon',
    cost: 6,
    description: 'Generi +3 ducati per ogni mano giocata.',
    descriptionEn: "Gain +3 ducats for every hand played.",
    trigger: 'on_hand_played',
  ...
  },
  {
    id: 'mano_nera',
    name: "'A Mano Nera",
    nameEn: "The Black Hand",
    emoji: '✊',
    rarity: 'uncommon',
    cost: 6,
    description: 'Le coppie danno mult ×4 invece di ×2.',
    descriptionEn: "Pairs give mult ×4 instead of ×2.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Blood of Naples",
    emoji: '🩸',
    rarity: 'uncommon',
    cost: 6,
    description: 'Se giochi solo carte rosse (Coppe + Denari): +40 chips e +2 mult.',
    descriptionEn: "If you play only red cards (Cups + Coins): +40 chips and +2 mult.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    descriptionEn: "+8 chips for each trump suit card played.",
    trigger: 'on_card_scored',
  ...
  // non dentro calculateScore). Portano il totale a 28 (il BRIEF dice "almeno 25").
  {
    ...
    nameEn: "The Cursed Horn",
    emoji: '🪬',
    rarity: 'uncommon',
    cost: 6,
    description: '+3 mult ogni volta che scarti una carta.',
    descriptionEn: "+3 mult every time you discard a card.",
  ...
  },
  {
    ...
    nameEn: "Neapolitan Dawn",
    emoji: '🌅',
    rarity: 'uncommon',
    cost: 6,
    description: 'All\'inizio di ogni round: +15 chips e +1 mult di base.',
    descriptionEn: "At the start of each round: +15 chips and +1 base mult.",
  ...
  },
  {
    ...
    descriptionEn: "If you also own The Pizzaiolo: Cups bonuses double.",
  ...
  // -------- RARE (5) --------
  {
    ...
    descriptionEn: "+1 mult per hand. Resets when you face a boss.",
    trigger: 'on_hand_played',
  ...
  },
  {
    id: 'tarantella',
    name: "'A Tarantella",
    nameEn: "The Tarantella",
    emoji: '💃',
    rarity: 'rare',
    cost: 8,
    description: 'Per ogni joker che possiedi, +0.5 mult ad ogni mano.',
    descriptionEn: "For each joker you own, +0.5 mult per hand.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "The Alchemist Wizard",
    emoji: '🧙',
    rarity: 'rare',
    cost: 8,
    description: 'Le coppie e i tris danno +50 chips bonus extra.',
    descriptionEn: "Pairs and Three-of-a-kind give +50 extra chips.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "San Gennaro's Bell",
    emoji: '🔔',
    rarity: 'rare',
    cost: 8,
    description: 'Se la mano contiene almeno una figura di OGNI seme: chips ×2.',
    descriptionEn: "If the hand has a face card of EVERY suit: chips ×2.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Fried Street Food",
    emoji: '🍤',
    rarity: 'rare',
    cost: 8,
    description: 'Se giochi 4+ carte: +80 chips e +3 mult.',
    descriptionEn: "If you play 4+ cards: +80 chips and +3 mult.",
    trigger: 'on_hand_played',
  ...
  // -------- LEGENDARY (2) --------
  {
    ...
    nameEn: "El Diez (Maradona)",
    emoji: '⚽',
    rarity: 'legendary',
    cost: 20,
    description: 'Mult ×3 ad ogni mano. Punto d\'oro: chips +100 se giochi una Napoletana.',
    descriptionEn: "Mult ×3 every hand. Golden goal: +100 chips if you play a Napoletana.",
    trigger: 'on_hand_played',
  ...
  },
  {
    ...
    nameEn: "Vesuvius Erupts",
    emoji: '🌋',
    rarity: 'legendary',
    cost: 20,
    description: 'Ogni Asso giocato: +50 chips e +1 mult. Effetto cumulativo.',
    descriptionEn: "Each Ace played: +50 chips and +1 mult. Cumulative.",
    trigger: 'on_card_scored',
...
const MAZZETTI = [
  {
    id: 'cicirinella', name: "'A Cicirinella", nameEn: "Little Sparrow", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Se giochi una combo da 2 carte: +3 mult.',
    descriptionEn: "If you play a 2-card combo: +3 mult.",
  ...
  {
    id: 'scupetta', name: "'A Scupetta", nameEn: "The Broom", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Ogni scarta fatta questo round vale +8 chips.',
    descriptionEn: "Each discard this round gives +8 chips.",
  ...
  {
    id: 'piscatore', name: "'O Piscatore", nameEn: "The Fisherman", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_card_scored',
    description: 'Ogni carta di Spade: +6 chips.',
    descriptionEn: "Each Swords card: +6 chips.",
  ...
  {
    id: 'canestro_pane', name: "'O Canestro 'e Pane", nameEn: "Bread Basket", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_round_start',
    description: 'Inizio round: +1 ducato.',
    descriptionEn: "Round start: +1 ducat.",
  ...
  {
    id: 'tammorra', name: "'A Tammorra", nameEn: "The Tammorra", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Se non hai scartato in questo round: +20 chips.',
    descriptionEn: "If you haven't discarded this round: +20 chips.",
  ...
  {
    id: 'quartino_vino', name: "'O Quartino 'e Vino", nameEn: "Quarter of Wine", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Se giochi almeno una figura: +1 mult.',
    descriptionEn: "If you play at least one face card: +1 mult.",
  ...
  {
    id: 'sfizio', name: "'O Sfizio", nameEn: "The Craving", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Se giochi 5 o più carte in una mano: +15 chips.',
    descriptionEn: "If you play 5 or more cards in a hand: +15 chips.",
  ...
  {
    id: 'bicchiere_amaro', name: "'O Bicchiere d'Amaro", nameEn: "Glass of Amaro", type: 'mazzetto',
    rarity: 'comune', trigger: 'on_hand_played',
    description: 'Ultima mano del round: chips ×1.5.',
    descriptionEn: "Last hand of the round: chips ×1.5.",
  ...
  {
    id: 'cornetto_rosso', name: "'O Cornetto Rosso", nameEn: "Red Horn", type: 'mazzetto',
    rarity: 'comune', trigger: 'passive',
    description: 'Briscola Coppe o Denari: +10 chips per mano.',
    descriptionEn: "Trump is Cups or Coins: +10 chips per hand.",
  ...
  {
    id: 'guapparia', name: "'A Guapparia", nameEn: "Street Swagger", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_hand_played',
    description: 'Nuovo record personale di mano: +4 mult.',
    descriptionEn: "New personal hand record: +4 mult.",
  ...
  {
    id: 'pulcinella_bianco', name: "Pulcinella Bianco", nameEn: "White Pulcinella", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_hand_played',
    description: 'Hai scarti inutilizzati: chips ×1.5.',
    descriptionEn: "You have unused discards: chips ×1.5.",
  ...
  {
    id: 'osteria_nobili', name: "'A Osteria d' 'e Nobili", nameEn: "The Nobles' Tavern", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_hand_played',
    description: 'Mano di sole figure (≥2): chips ×2 e +5 mult.',
    descriptionEn: "Hand of only face cards (≥2): chips ×2 and +5 mult.",
  ...
  {
    id: 'smorfia_vivente', name: "'A Smorfia Vivente", nameEn: "The Living Smorfia", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_card_scored',
    description: 'Carta valore 7: +25 chips e +1 mult.',
    descriptionEn: "Card value 7: +25 chips and +1 mult.",
  ...
  {
    id: 'munaciello_ladro', name: "'O Munaciello Ladro", nameEn: "Thieving Munaciello", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_discard',
    description: 'Ogni carta scartata: +2 mult.',
    descriptionEn: "Each discarded card: +2 mult.",
  ...
  {
    id: 'femmeniello', name: "'O Femmeniello", nameEn: "The Femmeniello", type: 'mazzetto',
    rarity: 'raro', trigger: 'passive',
    description: 'Passivo: +1 mult base per ogni calcolo.',
    descriptionEn: "Passive: +1 base mult per calculation.",
    effectCode: 'ctx.mult += 1;',
    emoji: '🌸',
    art: { bg: '#ff6ec7', icon: '🌸' },
  ...
  {
    id: 'tombola_card', name: "'A Tombola!", nameEn: "Tombola!", type: 'mazzetto',
    rarity: 'raro', trigger: 'on_hand_played',
    description: 'Primiera (4 semi diversi): +30 chips.',
    descriptionEn: "Primiera (4 different suits): +30 chips.",
  ...
  {
    id: 'cascione', name: "'O Cascione", nameEn: "The Big Box", type: 'mazzetto',
    ...
    descriptionEn: "Ace + trump card: +2 mult per trump card. Napoletana or Napola: +100 chips.",
  ...
  {
    id: 'san_gennaro_buono', name: "San Gennaro Buono", nameEn: "Good San Gennaro", type: 'mazzetto',
    rarity: 'leggendario', trigger: 'passive',
    description: 'Passivo: +2 mult. Il santo protegge sempre.',
    descriptionEn: "Passive: +2 mult. The saint always protects.",
    effectCode: 'ctx.mult += 2;',
    emoji: '⛪',
    art: { bg: '#c1272d', icon: '⛪' },
  ...
  {
    id: 'capodanno_napoletano', name: "'O Capodanno Napulitano", nameEn: "Neapolitan New Year", type: 'mazzetto',
    rarity: 'leggendario', trigger: 'on_round_start',
    description: 'Inizio Boss Blind: +5 mult × jolly/mazzetti in slot.',
    descriptionEn: "Boss Blind start: +5 mult × jokers/decks in slots.",
  ...
  {
    id: 'janara_amica', name: "'A Janara Amica", nameEn: "Friendly Janara", type: 'mazzetto',
    rarity: 'raro', trigger: 'passive',
    description: 'Passivo: +15 chips per ogni mano.',
    descriptionEn: "Passive: +15 chips per hand.",
...
const TAROTS = [
  {
    ...
    descriptionEn: 'Transform 2 selected cards into copies of a third chosen card.',
  ...
  },
  {
    ...
    descriptionEn: 'Permanently increases hand size by +1.',
  ...
  },
  {
    ...
    descriptionEn: '25% chance to make a random Joker \'Foil\' (chips ×1.5).',
  ...
  },
  {
    ...
    descriptionEn: 'Receive +50 ducats immediately.',
  ...
  },
  {
    ...
    descriptionEn: 'Transforms 30% of the deck into cards of a random suit.',
  ...
  },
  {
    ...
    descriptionEn: 'Destroys 2 random cards from the deck. Cruel but necessary.',
  ...
  },
  {
    ...
    descriptionEn: 'Draw 3 rare cards from the cosmos: add 3 Aces to the deck.',
  ...
  },
  {
    ...
    descriptionEn: 'All numeric cards (2,4,5,6) become 7 for this round.',
  ...
  },
  {
    ...
    descriptionEn: 'The next joker bought is free (costs 0 ducats).',
...
const ZODIAC_BONUSES = {
  ariete: {
    ...
    descEn: '+1 extra hand at the first round of every Ante. The Ram never gives up.',
    apply: (state) => { if (state.currentRun) state.currentRun.zodiacFlag_ariete = true; },
  },
  toro: {
    desc: '+20 ducati di partenza.',
    descEn: '+20 starting ducats. Solid and steady.',
...
const STRINGS = {
  it: {
    ...
    // Game labels
    'game.noJokers': 'Nessun jolly',
    'game.noTarots': 'Nessun tarocco',
    // Run info popup
    'runinfo.title': 'INFO RUN',
    'runinfo.ante': 'Ante',
    'runinfo.score': 'Punteggio',
    'runinfo.ducats': 'Ducati',
    'runinfo.trump': 'Briscola',
    'runinfo.jokersTitle': 'Jolly attivi',
    'runinfo.none': 'Nessun jolly',
    'runinfo.close': 'CHIUDI',
    // Joker popup
    'joker.triggerLabel': 'Trigger',
    // Tarot popup
    'tarot.use': 'USA ADESSO',
    // Rarity labels
    ...
    // Combo popup
    'combo.popupTitle': 'LE COMBO',
    'combo.colCombo': 'COMBO',
    'combo.colExample': 'ESEMPIO',
    'combo.colChips': 'CHIPS',
    'combo.colMult': '×',
    'combo.colHow': 'COME SI FA',
    'combo.tip': '💡 Napoletana, Scopa e Carico danno i punteggi più alti!',
    'combo.ok': 'CAPITO!',
    // Combo descriptions
    'combo.desc.single': 'qualsiasi carta singola',
    'combo.desc.coppia': '2 carte stesso valore',
    'combo.desc.tris': '3 carte stesso valore',
    'combo.desc.poker': '4 carte stesso valore',
    'combo.desc.sette_e_mezzo': '2 carte, somma ≤ 7.5 (figure = 0.5)',
    'combo.desc.bazzica': '5-6-7 di semi diversi',
    'combo.desc.briscola_reale': 'Asso + carte del seme briscola',
    'combo.desc.carico': 'F+C+R stesso seme',
    'combo.desc.napola_mista': 'A+2+3 semi diversi',
    'combo.desc.napoletana': 'A+2+3 stesso seme',
    'combo.desc.calabresella': 'R+C+A di 3 semi diversi',
    'combo.desc.primiera': '4 carte di 4 semi diversi',
    'combo.desc.scopa': '5 carte stesso seme',
    // Zodiac detail
    'zodiac.starsWatch': 'Le stelle guardano',
  },
  ...
  en: {
    ...
    // Game labels
    'game.noJokers': 'No jokers',
    'game.noTarots': 'No tarots',
    // Run info popup
    'runinfo.title': 'RUN INFO',
    'runinfo.ante': 'Ante',
    'runinfo.score': 'Score',
    'runinfo.ducats': 'Ducats',
    'runinfo.trump': 'Trump',
    'runinfo.jokersTitle': 'Active jokers',
    'runinfo.none': 'No jokers',
    'runinfo.close': 'CLOSE',
    // Joker popup
    'joker.triggerLabel': 'Trigger',
    // Tarot popup
    ...
    // Combo popup
    'combo.popupTitle': 'COMBOS',
    'combo.colCombo': 'COMBO',
    'combo.colExample': 'EXAMPLE',
    'combo.colChips': 'CHIPS',
    'combo.colMult': '×',
    'combo.colHow': 'HOW TO',
    'combo.tip': '💡 Napoletana, Scopa and Carico give the highest scores!',
    'combo.ok': 'GOT IT!',
    // Combo descriptions
    'combo.desc.single': 'any single card',
    'combo.desc.coppia': '2 cards same value',
    'combo.desc.tris': '3 cards same value',
    'combo.desc.poker': '4 cards same value',
    'combo.desc.sette_e_mezzo': '2 cards, sum ≤ 7.5 (face cards = 0.5)',
    'combo.desc.bazzica': '5-6-7 of different suits',
    'combo.desc.briscola_reale': 'Ace + cards of the trump suit',
    'combo.desc.carico': 'J+H+K same suit',
    'combo.desc.napola_mista': 'A+2+3 different suits',
    'combo.desc.napoletana': 'A+2+3 same suit',
    'combo.desc.calabresella': 'K+H+A of 3 different suits',
    'combo.desc.primiera': '4 cards of 4 different suits',
    'combo.desc.scopa': '5 cards same suit',
    'zodiac.starsWatch': 'The stars watch over',
  },
};
